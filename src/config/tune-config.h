/* src/config/tune-config.h.  Generated from tune-config.h.in by configure.  */
/* src/config/tune-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TUNE_CONFIG_H

#define TUNE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/tunecoin/tune/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tune Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tune Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tunecore"
